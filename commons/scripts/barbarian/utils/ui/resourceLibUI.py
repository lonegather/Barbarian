...
class Ui_resourceLibOption(ui.QtUI):
    def setupUi(self, resourceLibOption):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.resourceLibCentralwidget)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.resourceLibCBProject)
        ...
        self.resourceLibBtnLoad = QtWidgets.QPushButton(self.resourceLibCentralwidget)
    ...
    def retranslateUi(self, resourceLibOption):
        resourceLibOption.setWindowTitle(QtWidgets.QApplication.translate("resourceLibOption", "资产库", None))
        self.Label.setText(QtWidgets.QApplication.translate("resourceLibOption", "项目：", None))
        self.Label_2.setText(QtWidgets.QApplication.translate("resourceLibOption", "类型：", None))
        self.resourceLibRBChar.setText(QtWidgets.QApplication.translate("resourceLibOption", "角色", None))
        self.resourceLibRBProp.setText(QtWidgets.QApplication.translate("resourceLibOption", "道具", None))
        self.resourceLibRBScene.setText(QtWidgets.QApplication.translate("resourceLibOption", "场景", None))
        self.resourceLibBtnLoad.setText(QtWidgets.QApplication.translate("resourceLibOption", "加载", None))
