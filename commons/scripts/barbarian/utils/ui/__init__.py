...
class QMayaWindow(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("QMayaWindow {                                                             \n"
                           ...
                           "QPushButton:hover {                                                       \n"
                           "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, \n"
                           "                                      stop:0 rgba(150, 120, 160, 255),    \n"
                           "                                      stop:0.48 rgba(80, 60, 90, 255),    \n"
                           "                                      stop:0.52 rgba(50, 30, 60, 255),    \n"
                           ...
                           "                                stop: 0 #aa66cc, stop: 1 #9900aa);        \n"
                           "    border: 0px solid #bfcde4;                                            \n"
                           "}                                                                         \n"
                           "                                                                          \n"
                           "QTreeView::item:selected {                                                \n"
                           "    background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,               \n"
                           "                                stop: 0 #660099, stop: 1 #9933aa);        \n"
                           "}                                                                         \n"
                           "                                                                          \n"
                           "QTreeView::branch {                                                       \n"
                           "    border-image: none;                                                   \n"
                           ...
                           "    border-image: url(\"{icon_dir}line-more.png\") 0;                     \n"
                           "}                                                                         \n"
                           "                                                                          \n"
                           "QTreeView::branch:!adjoins-item:bottom {                                  \n"
                           ...
                           "        border-image: none;                                               \n"
                           "        image: url(\"{icon_dir}branch-closed.png\");                      \n"
                           "}                                                                         \n"
                           "                                                                          \n"
                           ...
                           "                                      stop:0.48 rgba(100, 50, 120, 255),  \n"
                           "                                      stop:0.52 rgba(80, 20, 100, 255),   \n"
                           "                                      stop:1 rgba(100, 50, 120, 255));    \n"
                           "}                                                                         \n"
                           "QProgressBar {                                                            \n"
                           "    text-align: center;                                                   \n"
                           "                                                                          \n"
                           "}                                                                         \n"
                           .replace("{icon_dir}", config.getPath(config.kIcon, "css/")))
