...
class Ui_CGTWWin(ui.QtUI):
    def setupUi(self, CGTWWin):
        ...
        self.CGTWBtnRefer = QtGui.QPushButton(self.CGTWPageAll)
    ...
    def retranslateUi(self, CGTWWin):
        ...
        self.CGTWBtnRefer.setText(QtGui.QApplication.translate("CGTWWin", "引用", None, QtGui.QApplication.UnicodeUTF8))
