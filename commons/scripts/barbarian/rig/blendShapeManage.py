...
def Edit_UI():
	...
	cmds.textScrollList('targetBlendShapeText',height =  200,width = 300,sc = 'inbetweenWieght(),getBlendShapeIndex()')
	...
	cmds.text(l= '',h=5)
	b2=cmds.button('EditFinsihButton',label = 'Edit',c='EditFinishButton()',width = 60)
	cmds.setParent('..')
...
def blendShapeManage():
	...
	Clone_UI()
	cmds.setParent( '..' )
	cmds.tabLayout( tabs,cc='freshTargetBlendShape("append")', edit=True,tabLabel=(('child1', 'Create'),('child2', 'Edit'),('child3', 'Clone')))
	cmds.setParent( '..' )
