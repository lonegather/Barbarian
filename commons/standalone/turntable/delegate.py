...
class FileDelegate(QtGui.QStyledItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        if index.data(model.scene_stat) in ["generating", "rendering", "compositing"]:
        ...
        else: painter.fillRect(item_rect, QtGui.QColor(100, 255, 255, 255))
        ...
        status_map = {"init":u"就绪", "generating":u"正在生成...", 
        ...
        painter.drawText(type_rect, QtCore.Qt.AlignBottom, status_map[index.data(model.scene_stat)])
